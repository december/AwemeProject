...
alpha = [1e-10, 1e-10, 1e-6, 1e-5, 1e-5, 1e-5, 1e-5]
total = 10000
threshold = 0.0001
...
cnt = 0
p = [0.0095552090634552, 0.0005179328462228, 0.1932614658, -2.3137, -2.077941, -2.3648415, -2.322292] #a, b, theta, k1, k2, k3, k4
